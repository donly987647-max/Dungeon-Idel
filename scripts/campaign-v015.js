...
(()=>{
  ...
  function hunt(){return `<div class="campaign-heading"><small>EXPANSION PLAN</small><h2>오늘의 박멸 영업</h2><p>산골 첫 영업부터 용사 왕국 인수까지.</p></div><aside class="campaign-rule">일반 전투 <b>500회</b> 완료 → 보스 출현 해금<br>이후 조우마다 <b>1.5%</b> · 최대 100회 조우 안에 등장 · 첫 처치 시 다음 챕터 개방</aside><div class="campaign-list">${S.sites.map(card).join('')}</div>`;}
  function nextStep(){
